...
export class FilesController {
  ...
  @ApiOperation({
    summary: 'Check existence of a batch of ids for a given type',
  })
  @ApiParam({
    name: 'type',
  ...
  @ApiOkResponse({
    description:
      'Map of requested id to its storage tier, or null if it does not exist',
    schema: {
      type: 'object',
      additionalProperties: {
        type: 'string',
        enum: ['HOT', 'ARCHIVE', null],
        nullable: true,
      },
  ...
  @ApiOperation({
    summary: 'Upload a new file (fails if the id already exists)',
  })
  @ApiParam({
    name: 'type',
    description: 'File type/category',
  ...
  @ApiBadRequestResponse({
    description: 'Missing/empty file, or file exceeds the size limit',
  })
  @ApiNotFoundResponse({ description: 'Unknown type' })
  @ApiConflictResponse({
    description: 'A file with this type/id already exists',
  })
  async create(
  ...
  @ApiHeader({
    name: 'X-Storage-Tier',
    description: 'Storage tier the file was served from (HOT or ARCHIVE)',
  })
  @ApiOkResponse({
  ...
  @Head(':type/:id')
  @ApiOperation({
    summary: "Check a file's metadata without fetching its bytes",
  })
  @ApiParam({
    name: 'type',
    description: 'File type/category',
  ...
  @ApiHeader({
    name: 'X-Storage-Tier',
    description: 'Storage tier the file is stored in (HOT or ARCHIVE)',
  })
